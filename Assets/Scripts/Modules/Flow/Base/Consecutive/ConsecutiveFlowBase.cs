...
{
    public abstract class ConsecutiveFlowBase : FlowBase
    {
        protected ConsecutiveFlowBase(ILogger logger, ITypeFactory factory) : base(logger, factory) { }
